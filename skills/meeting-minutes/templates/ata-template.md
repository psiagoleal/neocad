<!-- Caminho relativo: skills/meeting-minutes/templates/ata-template.md -->
<!--
  Template de ATA / resumo de reunião. Genérico e reutilizável.
  - Template PADRÃO (fallback): use-o apenas se o usuário NÃO fornecer um modelo próprio.
  - Preencha apenas com o que foi dito; use "não registrado" onde faltar.
  - Se o conteúdo for confidencial: salve na ÁREA RESTRITA do projeto (não versionar);
    referencie pessoas/organizações por papel ou índice no material versionado.
  - Marque caixas trocando ☐ por ☑ apenas com evidência explícita.
-->

# ATA / Resumo — <assunto da reunião>
...
## Observações e sentimento da reunião

> Seção de síntese qualitativa — o que se extrai da conversa além da pauta formal.
